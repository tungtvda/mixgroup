...
class list_logo
{
    public $id,$name,$name_en,$name_cn,$img,$date,$link,$link_fanpage,$link_youtube,$content,$content_en,$content_cn,$position;
    ...
    $this->link_youtube=isset($data['link_youtube'])?$data['link_youtube']:'';
    ...
    public function encode()
        {
            ...
            $this->link_youtube=addslashes($this->link_youtube);
    ...
    public function decode()
        {
            ...
            $this->link_youtube=stripslashes($this->link_youtube);
